...
const greeting = {
  ...
  subTitle: "Data Scientist, Artificial Intelligence Enthusiast . Always learning.",
  resumeLink:
    "#",
...
const socialMediaLinks = {
  ...
  github: "https://github.com/ayyodeji",
  linkedin: "https://www.linkedin.com/in/ajayi-ayodeji-262474201/",
  gmail: "ajayi.ayyodeji@gmail.com",
  gitlab: "https://gitlab.com/ayyodeji",
  twitter: "https://twitter.com/ayyodeji_",
  instagram: "https://www.instagram.com/ayyodeji/",
};
...
const skills = {
  data: [
    ...
    },
    {
      ...
      skills: [
        "⚡ Developing highly sophisticated deep learning models",
        "⚡ acquainted with Computer Vision, Natural Language Processing and Machine Learning",
        "⚡ Experience with AWS Sagemaker and Microsoft Azure AI Lab",
        "⚡ Experience in Artificial Intelligence Research",
        "⚡ Experience with ML, DL & AGI technology",
      ],
      softwareSkills: [
        {
          skillName: "python",
        ...
        {
          skillName: "Java",
          fontAwesomeClassname: "vscode-icons:file-type-jar",
          style: {
            color: "#0865A6",
          },
        },
...
const degrees = {
  degrees: [
    {
      title: "Landmark University",
      subtitle: "Bachelor of Science (Computer Science)",
      logo_path: "lmulogox.png",
      alt_name: "LMU",
      duration: "2018 - 2022",
      descriptions: [
        "I have been awarded my Bachelor of Science degree in Computer Science.",
        // "⚡ I have studied core subjects like Data Structures, DBMS, Networking, Security, etc.",
        // "⚡ I have also completed various online courses for Backend , Web , Mobile App Development, etc.",
        // "⚡ I have implemented several projects based on what I've leart under my Computer Engineering course. ",
      ],
      website_link: "http://www.lmu.edu.ng/",
    },
  ],
};
...
const projectsHeader = {
  title: "Projects",
  description:
    "My projects make use of a vast variety of latest technology tools. My best experience is to build elite machine learning models, ETL, and Deploying Projects. Below are some of my projects. Note that not all of the mentioned projects are on GitHub yet.",
...
const contactPageData = {
  contactSection: {
    ...
    description:
      "You can contact me at through all listed media. Thank you for viewing my portfolio. ",
  },
  blogSection: {
    title: "Blogs",
    subtitle:
  ...
  data: [
    {
      ...
      url: "https://github.com/Ayyodeji/Face-Recognition",
      description:
    ...
    },
    {
      ...
      languages: [
        ...
        {
          name: "Jupyter",
          iconifyClass: "vscode-icons:file-type-jupyter",
        },
      ],
    },
    {
      ...
      languages: [
        ...
        {
          name: "Numpy",
          iconifyClass: "vscode-icons:file-type-numpy",
        },
      ],
    },
    {
